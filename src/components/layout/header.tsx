...
export function Header() {
  ...
  return (
    <>
      <header className={cn(
        "fixed top-0 left-0 right-0 z-40 h-14 transition-all duration-300 bg-white",
        scrolled ? "shadow-sm" : ""
      )}>
        <div className="flex items-center justify-between h-full px-4">
          <Link href="/sales" className="flex items-center gap-2">
            ...
            <span className="font-black text-lg tracking-tight text-[var(--teuco-green)] uppercase hidden sm:block">
