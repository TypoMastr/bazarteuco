...
import { exportToPDF, exportToWhatsApp, ProductData } from '@/lib/export-utils'

interface ExportMenuProps {
  products: ProductData[]
}

export function ExportMenu({ products }: ExportMenuProps) {
  ...
  function handleWhatsApp() {
    exportToWhatsApp('products', products)
    setOpen(false)
  }
